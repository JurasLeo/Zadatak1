...
function tokenZahtjev() {
    ...
    const searchBtn = document.getElementById('btn').addEventListener('click', search)
...
const accesToken = 'wI2x8I8Cm5V-5Rl57Pu8_g'
const btnPretrazitelj = document.getElementById('btnPretrazitelj').addEventListener('click', searchCompany);
urlTvrtke = 'https://sudreg-data.gov.hr/api/javni/tvrtke';

async function searchCompany() {

    try {
        const response = await fetch(urlTvrtke, {
            headers: {
